(function ($) {
    $.religions = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#religion-form",
            formContainer: ".js-religion-form-container",
            gridSelector: "#religion-grid",
            gridContainer: ".js-religion-grid-container",
            editSelector: ".js-religion-edit",
            saveSelector: ".js-religion-save",
            selectAllSelector: "#religion-check-all",
            deleteSelector: ".js-religion-delete-confirm",
            deleteModal: "#religion-delete-modal",
            finalDeleteSelector: ".js-religion-delete",
            clearSelector: ".js-religion-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-religion-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-religion-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadReligions(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadReligions(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "religionCode", "className": "text-center", width: "2%", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "religionCode", width: "7%", "render": function (data) {
                            return `<a class='btn js-religion-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "religion", "autowidth": true, "className": "text-center" },
