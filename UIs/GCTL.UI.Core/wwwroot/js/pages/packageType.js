(function ($) {
    $.packageType = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#PackageType-form",
            formContainer: ".js-PackageType-form-container",
            gridSelector: "#PackageType-grid",
            gridContainer: ".js-PackageType-grid-container",
            editSelector: ".js-PackageType-edit",
            saveSelector: ".js-PackageType-save",
            selectAllSelector: "#PackageType-check-all",
            deleteSelector: ".js-PackageType-delete-confirm",
            deleteModal: "#PackageType-delete-modal",
            finalDeleteSelector: ".js-PackageType-delete",
            clearSelector: ".js-PackageType-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-PackageType-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-PackageType-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-PackageTypeId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#PackageType').val();

            if (!col) {
                toastr.info('Enter Package Type');
                $('#PackageType').trigger('focus');
                return false;
            }
            return true;
        }
