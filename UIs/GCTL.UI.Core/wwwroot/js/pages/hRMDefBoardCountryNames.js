...
(function ($) {
    $.hRMDefBoardCountryNames = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HRMDefBoardCountryNames-form",
            formContainer: ".js-HRMDefBoardCountryNames-form-container",
            gridSelector: "#HRMDefBoardCountryNames-grid",
            gridContainer: ".js-HRMDefBoardCountryNames-grid-container",
            editSelector: ".js-HRMDefBoardCountryNames-edit",
            saveSelector: ".js-HRMDefBoardCountryNames-save",
            selectAllSelector: "#HRMDefBoardCountryNames-check-all",
            deleteSelector: ".js-HRMDefBoardCountryNames-delete-confirm",
            deleteModal: "#HRMDefBoardCountryNames-delete-modal",
            finalDeleteSelector: ".js-HRMDefBoardCountryNames-delete",
            clearSelector: ".js-HRMDefBoardCountryNames-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HRMDefBoardCountryNames-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HRMDefBoardCountryNames-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-BoardCode-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var degName = $('#BoardName').val();
            if (!degName) {
                toastr.info('Enter Board Name');
                $('#BoardName').trigger('focus');
                return false;
            }
