//'use strict'
(function ($) {
    $.companyInfos = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#CompanyInfos-form",
            formContainer: ".js-CompanyInfos-form-container",
            gridSelector: "#CompanyInfos-grid",
            gridContainer: ".js-CompanyInfos-grid-container",
            editSelector: ".js-CompanyInfos-edit",
            saveSelector: ".js-CompanyInfos-save",
            selectAllSelector: "#CompanyInfos-check-all",
            deleteSelector: ".js-CompanyInfos-delete-confirm",
            deleteModal: "#CompanyInfos-delete-modal",
            finalDeleteSelector: ".js-CompanyInfos-delete",
            clearSelector: ".js-CompanyInfos-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-CompanyInfos-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-CompanyInfos-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-CompanyNameId-code").val();
                let name = self.val();
