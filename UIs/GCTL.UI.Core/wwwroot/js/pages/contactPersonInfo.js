(function ($) {
    $.contactPersonInfo = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#ContactPersonInfo-form",
            formContainer: ".js-ContactPersonInfo-form-container",
            gridSelector: "#ContactPersonInfo-grid",
            gridContainer: ".js-ContactPersonInfo-grid-container",
            editSelector: ".js-ContactPersonInfo-edit",
            saveSelector: ".js-ContactPersonInfo-save",
            selectAllSelector: "#ContactPersonInfo-check-all",
            deleteSelector: ".js-ContactPersonInfo-delete-confirm",
            deleteModal: "#ContactPersonInfo-delete-modal",
            finalDeleteSelector: ".js-ContactPersonInfo-delete",
            clearSelector: ".js-ContactPersonInfo-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-ContactPersonInfo-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-ContactPersonInfo-check-availability",
            haseFile: false,
        ...
        function validation() {
            ...
            var col = $('#ContactPersonName').val();

            if (!col) {
                toastr.info('Enter Contact Person Name');
                $('#ContactPersonName').trigger('focus');
                return false;
            }
            return true;
        }
        ...
        function loadSNCId() {
            $.ajax({
                url: "/ContactPersonInfo/GenerateNewId",
                type: "GET",
                dataType: "json",
                ...
                error: function (xhr, status, error) {
                    console.error("Error fetching Cpid:", error);
                }
            })
        }
