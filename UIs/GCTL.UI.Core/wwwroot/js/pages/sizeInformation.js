(function ($) {
    $.sizeInformation = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#SizeInformation-form",
            formContainer: ".js-SizeInformation-form-container",
            gridSelector: "#SizeInformation-grid",
            gridContainer: ".js-SizeInformation-grid-container",
            editSelector: ".js-SizeInformation-edit",
            saveSelector: ".js-SizeInformation-save",
            selectAllSelector: "#SizeInformation-check-all",
            deleteSelector: ".js-SizeInformation-delete-confirm",
            deleteModal: "#SizeInformation-delete-modal",
            finalDeleteSelector: ".js-SizeInformation-delete",
            clearSelector: ".js-SizeInformation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-SizeInformation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-SizeInformation-check-availability",
            haseFile: false,
