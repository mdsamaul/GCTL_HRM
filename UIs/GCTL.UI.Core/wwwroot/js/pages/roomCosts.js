...
(function ($) {
    $.roomCosts = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#roomcost-form",
            formContainer: ".js-roomcost-form-container",
            gridSelector: "#roomcost-grid",
            gridContainer: ".js-roomcost-grid-container",
            editSelector: ".js-roomcost-edit",
            saveSelector: ".js-roomcost-save",
            selectAllSelector: "#roomcost-check-all",
            deleteSelector: ".js-roomcost-delete-confirm",
            deleteModal: "#roomcost-delete-modal",
            finalDeleteSelector: ".js-roomcost-delete",
            clearSelector: ".js-roomcost-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-roomcost-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-roomcost-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadRoomCosts(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadRoomCosts(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "roomCostCode", "className": "text-center", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "roomCostCode", "render": function (data) {
                            return `<a class='btn js-roomcost-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "roomNo", "autowidth": true, "className": "text-center" },
                    { "data": "cost", "autowidth": true, "className": "text-center" },
                    { "data": "roomTypeName", "autowidth": true, "className": "text-center" },                   
                    { "data": "remarks", "autowidth": true, "className": "text-center" }
                ],
                lengthChange: true,
                pageLength: 10,
                lengthMenu: [
