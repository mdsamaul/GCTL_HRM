(function ($) {
    $.seasonInformation = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#SeasonInformation-form",
            formContainer: ".js-SeasonInformation-form-container",
            gridSelector: "#SeasonInformation-grid",
            gridContainer: ".js-SeasonInformation-grid-container",
            editSelector: ".js-SeasonInformation-edit",
            saveSelector: ".js-SeasonInformation-save",
            selectAllSelector: "#SeasonInformation-check-all",
            deleteSelector: ".js-SeasonInformation-delete-confirm",
            deleteModal: "#SeasonInformation-delete-modal",
            finalDeleteSelector: ".js-SeasonInformation-delete",
            clearSelector: ".js-SeasonInformation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-SeasonInformation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-SeasonInformation-check-availability",
            haseFile: false,
