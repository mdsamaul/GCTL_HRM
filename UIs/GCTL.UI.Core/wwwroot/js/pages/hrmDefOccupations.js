...
(function ($) {
    $.hrmDefOccupations = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefOccupations-form",
            formContainer: ".js-HrmDefOccupations-form-container",
            gridSelector: "#HrmDefOccupations-grid",
            gridContainer: ".js-HrmDefOccupations-grid-container",
            editSelector: ".js-HrmDefOccupations-edit",
            saveSelector: ".js-HrmDefOccupations-save",
            selectAllSelector: "#HrmDefOccupations-check-all",
            deleteSelector: ".js-HrmDefOccupations-delete-confirm",
            deleteModal: "#HrmDefOccupations-delete-modal",
            finalDeleteSelector: ".js-HrmDefOccupations-delete",
            clearSelector: ".js-HrmDefOccupations-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefOccupations-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefOccupations-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-OccupationCode-code").val();
                let name = self.val();
        ...
        function loadTable() {
            $.get(settings.baseUrl + "/GetTableData")
                ...
                .fail(() => toastr.warning("Failed to load table data."));
        }
        ...
        function validation() {
            ...
            var occupationName = $('#Occupation').val();
            if (!occupationName) {
                toastr.info('Enter Occupation Name');
                $('#Occupation').trigger('focus');
                return false;
            }
