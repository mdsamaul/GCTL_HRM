(function ($) {
    $.colorInformation = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#ColorInformation-form",
            formContainer: ".js-ColorInformation-form-container",
            gridSelector: "#ColorInformation-grid",
            gridContainer: ".js-ColorInformation-grid-container",
            editSelector: ".js-ColorInformation-edit",
            saveSelector: ".js-ColorInformation-save",
            selectAllSelector: "#ColorInformation-check-all",
            deleteSelector: ".js-ColorInformation-delete-confirm",
            deleteModal: "#ColorInformation-delete-modal",
            finalDeleteSelector: ".js-ColorInformation-delete",
            clearSelector: ".js-ColorInformation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-ColorInformation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-ColorInformation-check-availability",
            haseFile: false,
