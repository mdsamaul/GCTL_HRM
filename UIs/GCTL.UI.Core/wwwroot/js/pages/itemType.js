(function ($) {
    $.itemType = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#ItemType-form",
            formContainer: ".js-ItemType-form-container",
            gridSelector: "#ItemType-grid",
            gridContainer: ".js-ItemType-grid-container",
            editSelector: ".js-ItemType-edit",
            saveSelector: ".js-ItemType-save",
            selectAllSelector: "#ItemType-check-all",
            deleteSelector: ".js-ItemType-delete-confirm",
            deleteModal: "#ItemType-delete-modal",
            finalDeleteSelector: ".js-ItemType-delete",
            clearSelector: ".js-ItemType-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-ItemType-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-ItemType-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-ItemTypeId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var sty = $('#ItemName').val();

            if (!sty) {
                toastr.info('Enter Item Name');
