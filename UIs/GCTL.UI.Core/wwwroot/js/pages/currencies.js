(function ($) {
    $.currencies = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#currency-form",
            formContainer: ".js-currency-form-container",
            gridSelector: "#currency-grid",
            gridContainer: ".js-currency-grid-container",
            editSelector: ".js-currency-edit",
            saveSelector: ".js-currency-save",
            selectAllSelector: "#currency-check-all",
            deleteSelector: ".js-currency-delete-confirm",
            deleteModal: "#currency-delete-modal",
            finalDeleteSelector: ".js-currency-delete",
            clearSelector: ".js-currency-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-currency-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-currency-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadCurrencies(settings.baseUrl, settings.gridSelector);
            initialize();
            ...
            $("body").on("keyup", `.symbol`, function () {
                $(settings.decimalSelector).trigger("keyup");
            });
        ...
        function loadCurrencies(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "currencyId", "className": "text-center", "render":
                            function (data)
                     {
                    ...
                    {
                        "data": "currencyId", "render": function (data) {
                            return `<a class='btn js-currency-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "currencyName", "autowidth": true, "className": "text-center" },
                    { "data": "shortName", "autowidth": true, "className": "text-center" },
                    { "data": "symbol", "autowidth": true, "className": "text-center" },
                    { "data": "decimalPlaces", "className": "text-center", "autowidth": true },
                    { "data": "negativeFormat", "className": "text-center", "autowidth": true }
                ],
                lengthChange: true,
                pageLength: 10,
                lengthMenu: [
