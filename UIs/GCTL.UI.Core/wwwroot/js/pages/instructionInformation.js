(function ($) {
    $.instructionInformation = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#InstructionInformation-form",
            formContainer: ".js-InstructionInformation-form-container",
            gridSelector: "#InstructionInformation-grid",
            gridContainer: ".js-InstructionInformation-grid-container",
            editSelector: ".js-InstructionInformation-edit",
            saveSelector: ".js-InstructionInformation-save",
            selectAllSelector: "#InstructionInformation-check-all",
            deleteSelector: ".js-InstructionInformation-delete-confirm",
            deleteModal: "#InstructionInformation-delete-modal",
            finalDeleteSelector: ".js-InstructionInformation-delete",
            clearSelector: ".js-InstructionInformation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-InstructionInformation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-InstructionInformation-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-InstructionId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#Instruction').val();

            if (!col) {
                toastr.info('Enter Instruction');
                $('#Instruction').trigger('focus');
                return false;
            }
            return true;
        }
