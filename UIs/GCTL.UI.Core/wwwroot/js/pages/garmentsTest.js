(function ($) {
    $.garmentsTest = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#GarmentsTest-form",
            formContainer: ".js-GarmentsTest-form-container",
            gridSelector: "#GarmentsTest-grid",
            gridContainer: ".js-GarmentsTest-grid-container",
            editSelector: ".js-GarmentsTest-edit",
            saveSelector: ".js-GarmentsTest-save",
            selectAllSelector: "#GarmentsTest-check-all",
            deleteSelector: ".js-GarmentsTest-delete-confirm",
            deleteModal: "#GarmentsTest-delete-modal",
            finalDeleteSelector: ".js-GarmentsTest-delete",
            clearSelector: ".js-GarmentsTest-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-GarmentsTest-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-GarmentsTest-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-GarmentsTestD-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#GarmentsTestName').val();

            if (!col) {
                toastr.info('Enter Garments Test Name');
                $('#GarmentsTestName').trigger('focus');
                return false;
            }
            return true;
        }
