(function ($) {
    $.roomTypes = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#roomtype-form",
            formContainer: ".js-roomtype-form-container",
            gridSelector: "#roomtype-grid",
            gridContainer: ".js-roomtype-grid-container",
            editSelector: ".js-roomtype-edit",
            saveSelector: ".js-roomtype-save",
            selectAllSelector: "#roomtype-check-all",
            deleteSelector: ".js-roomtype-delete-confirm",
            deleteModal: "#roomtype-delete-modal",
            finalDeleteSelector: ".js-roomtype-delete",
            clearSelector: ".js-roomtype-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-roomtype-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-roomtype-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadRoomTypes(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadRoomTypes(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "roomTypeCode", "className": "text-center", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "roomTypeCode", "render": function (data) {
                            return `<a class='btn js-roomtype-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "roomTypeName", "autowidth": true, "className": "text-center" },
                    { "data": "roomTypeShortName", "autowidth": true, "className": "text-center" },
                    {
                        "data": "roomFacilities", "autowidth": true,
