...
(function ($) {
    $.courseTitle = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#CourseTitle-form",
            formContainer: ".js-CourseTitle-form-container",
            gridSelector: "#CourseTitle-grid",
            gridContainer: ".js-CourseTitle-grid-container",
            editSelector: ".js-CourseTitle-edit",
            saveSelector: ".js-CourseTitle-save",
            selectAllSelector: "#CourseTitle-check-all",
            deleteSelector: ".js-CourseTitle-delete-confirm",
            deleteModal: "#CourseTitle-delete-modal",
            finalDeleteSelector: ".js-CourseTitle-delete",
            clearSelector: ".js-CourseTitle-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-CourseTitle-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-CourseTitle-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-CourseCode-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var degName = $('#CourseName').val();
            if (!degName) {
                toastr.info('Enter CourseTitle');
