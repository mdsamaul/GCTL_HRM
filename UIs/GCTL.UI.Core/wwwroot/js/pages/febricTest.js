(function ($) {
    $.febricTest = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#FebricTest-form",
            formContainer: ".js-FebricTest-form-container",
            gridSelector: "#FebricTest-grid",
            gridContainer: ".js-FebricTest-grid-container",
            editSelector: ".js-FebricTest-edit",
            saveSelector: ".js-FebricTest-save",
            selectAllSelector: "#FebricTest-check-all",
            deleteSelector: ".js-FebricTest-delete-confirm",
            deleteModal: "#FebricTest-delete-modal",
            finalDeleteSelector: ".js-FebricTest-delete",
            clearSelector: ".js-FebricTest-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-FebricTest-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-FebricTest-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-FebricTestD-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#FebricTestName').val();

            if (!col) {
                toastr.info('Enter Febric Test Name');
                $('#FebricTestName').trigger('focus');
                return false;
            }
            return true;
        }
