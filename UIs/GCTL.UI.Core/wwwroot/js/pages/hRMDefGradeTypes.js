...
(function ($) {
    $.hRMDefGradeTypes = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefGradeTypes-form",
            formContainer: ".js-HrmDefGradeTypes-form-container",
            gridSelector: "#HrmDefGradeTypes-grid",
            gridContainer: ".js-HrmDefGradeTypes-grid-container",
            editSelector: ".js-HrmDefGradeTypes-edit",
            saveSelector: ".js-HrmDefGradeTypes-save",
            selectAllSelector: "#HrmDefGradeTypes-check-all",
            deleteSelector: ".js-HrmDefGradeTypes-delete-confirm",
            deleteModal: "#HrmDefGradeTypes-delete-modal",
            finalDeleteSelector: ".js-HrmDefGradeTypes-delete",
            clearSelector: ".js-HrmDefGradeTypes-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefGradeTypes-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefGradeTypes-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-GradeTypeId-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var degName = $('#GradeType').val();
            if (!degName) {
                toastr.info('Enter Grade Type');
                $('#GradeType').trigger('focus');
                return false;
            }
