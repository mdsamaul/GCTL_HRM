(function ($) {
    $.packagingInformation = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#PackagingInformation-form",
            formContainer: ".js-PackagingInformation-form-container",
            gridSelector: "#PackagingInformation-grid",
            gridContainer: ".js-PackagingInformation-grid-container",
            editSelector: ".js-PackagingInformation-edit",
            saveSelector: ".js-PackagingInformation-save",
            selectAllSelector: "#PackagingInformation-check-all",
            deleteSelector: ".js-PackagingInformation-delete-confirm",
            deleteModal: "#PackagingInformation-delete-modal",
            finalDeleteSelector: ".js-PackagingInformation-delete",
            clearSelector: ".js-PackagingInformation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-PackagingInformation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-PackagingInformation-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-PackageId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#PackageName').val();

            if (!col) {
                toastr.info('Enter Package Name');
