(function ($) {
    $.threadCount = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#ThreadCount-form",
            formContainer: ".js-ThreadCount-form-container",
            gridSelector: "#ThreadCount-grid",
            gridContainer: ".js-ThreadCount-grid-container",
            editSelector: ".js-ThreadCount-edit",
            saveSelector: ".js-ThreadCount-save",
            selectAllSelector: "#ThreadCount-check-all",
            deleteSelector: ".js-ThreadCount-delete-confirm",
            deleteModal: "#ThreadCount-delete-modal",
            finalDeleteSelector: ".js-ThreadCount-delete",
            clearSelector: ".js-ThreadCount-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-ThreadCount-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-ThreadCount-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-ThreadCountId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#ThreadCountName').val();

            if (!col) {
                toastr.info('Enter Thread Count Name');
                $('#ThreadCountName').trigger('focus');
                return false;
            }
