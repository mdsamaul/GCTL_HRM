...
(function ($) {
    $.hrmDefExamGroupInfos = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefExamGroupInfos-form",
            formContainer: ".js-HrmDefExamGroupInfos-form-container",
            gridSelector: "#HrmDefExamGroupInfos-grid",
            gridContainer: ".js-HrmDefExamGroupInfos-grid-container",
            editSelector: ".js-HrmDefExamGroupInfos-edit",
            saveSelector: ".js-HrmDefExamGroupInfos-save",
            selectAllSelector: "#HrmDefExamGroupInfos-check-all",
            deleteSelector: ".js-HrmDefExamGroupInfos-delete-confirm",
            deleteModal: "#HrmDefExamGroupInfos-delete-modal",
            finalDeleteSelector: ".js-HrmDefExamGroupInfos-delete",
            clearSelector: ".js-HrmDefExamGroupInfos-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefExamGroupInfos-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefExamGroupInfos-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-GroupCode-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var degName = $('#GroupName').val();
            if (!degName) {
                toastr.info('Enter Group Name');
