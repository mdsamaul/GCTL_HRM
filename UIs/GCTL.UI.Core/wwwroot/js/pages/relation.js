(function ($) {
    $.relation = function (options) {
        ...
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#relation-form",
            formContainer: ".js-relation-form-container",
            gridSelector: "#relation-grid",
            gridContainer: ".js-relation-grid-container",
            editSelector: ".js-relation-edit",
            saveSelector: ".js-relation-save",
            selectAllSelector: "#relation-check-all",
            deleteSelector: ".js-relation-delete-confirm",
            deleteModal: "#relation-delete-modal",
            finalDeleteSelector: ".js-relation-delete",
            clearSelector: ".js-relation-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-relation-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-relation-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadrelations(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadrelations(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "relationCode", "className": "text-center", width: "2%",
                        "render": function (data) {
                            return `<input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "relationCode", width:"5%", "render": function (data) {
                            return `<a class='btn js-relation-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "relation", "autowidth": true, "className": "text-center" }
