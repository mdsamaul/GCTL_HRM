    ...
    $.salesReports = function (options) {
        ...
        $(() => {            
            ...
            $("body").on("click", ".js-bill-export", function () {
                ...
                window.open(
                    settings.baseUrl + `/Export?billTypeId=${billType}&patientTypeId=${patientType}&fromDate=${fromDate}&toDate=${toDate}&doctorId=${doctorId}&referenceId=${referenceId}&reportType=Sales&reportRenderType=${reportRenderType}`,
                    "_blank"
                )
            });
