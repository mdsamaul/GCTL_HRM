(function ($) {
    $.supplierType = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#SupplierType-form",
            formContainer: ".js-SupplierType-form-container",
            gridSelector: "#SupplierType-grid",
            gridContainer: ".js-SupplierType-grid-container",
            editSelector: ".js-SupplierType-edit",
            saveSelector: ".js-SupplierType-save",
            selectAllSelector: "#SupplierType-check-all",
            deleteSelector: ".js-SupplierType-delete-confirm",
            deleteModal: "#SupplierType-delete-modal",
            finalDeleteSelector: ".js-SupplierType-delete",
            clearSelector: ".js-SupplierType-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-SupplierType-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-SupplierType-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-SupplierTypeId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#SupplierTypeName').val();

            if (!col) {
                toastr.info('Enter Supplier Type Name');
                $('#SupplierTypeName').trigger('focus');
                return false;
            }
            return true;
        }
