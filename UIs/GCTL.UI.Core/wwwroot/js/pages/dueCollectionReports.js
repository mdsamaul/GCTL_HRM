(function ($) {
    $.dueCollectionReports = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
        ...
        $(() => {
            ...
            $("body").on("click", ".js-collection-export", function () {
                ...
                window.open(
                    settings.baseUrl + `/Export?billTypeId=${billType}&patientTypeId=${patientType}&fromDate=${fromDate}&toDate=${toDate}&doctorId=${doctorId}&referenceId=${referenceId}&reportType=DueCollections&reportRenderType=${reportRenderType}`,
                    "_blank"
                )
            });
