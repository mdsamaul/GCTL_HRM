(function ($) {
    $.banks = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#bank-form",
            formContainer: ".js-bank-form-container",
            gridSelector: "#bank-grid",
            gridContainer: ".js-bank-grid-container",
            editSelector: ".js-bank-edit",
            saveSelector: ".js-bank-save",
            selectAllSelector: "#bank-check-all",
            deleteSelector: ".js-bank-delete-confirm",
            deleteModal: "#bank-delete-modal",
            finalDeleteSelector: ".js-bank-delete",
            clearSelector: ".js-bank-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-bank-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-bank-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadBanks(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadBanks(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "bankId", "className": "text-center", width: "40px", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "bankId", "className": "text-center", "render": function (data) {
                            return `<a class='btn js-bank-edit' data-id='${data}'>${data}</a>`;
                        }
                    },
