(function ($) {
    $.controlLedger = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#controlLedger-form",
            formContainer: ".js-controlLedger-form-container",
            gridSelector: "#controlLedger-grid",
            gridContainer: ".js-controlLedger-grid-container",
            editSelector: ".js-controlLedger-edit",
            saveSelector: ".js-controlLedger-save",
            selectAllSelector: "#controlLedger-check-all",
            deleteSelector: ".js-controlLedger-delete-confirm",
            deleteModal: "#controlLedger-delete-modal",
            finalDeleteSelector: ".js-controlLedger-delete",
            clearSelector: ".js-controlLedger-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-controlLedger-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-controlLedger-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadcontrolLedger(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadcontrolLedger(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "controlLedgerCodeNo", "className": "text-center", width: "2%",
                        "render": function (data) {
                            return `<input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "controlLedgerCodeNo", width:"5%", "render": function (data) {
                            return `<a class='btn js-controlLedger-edit' style='color:blue' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
