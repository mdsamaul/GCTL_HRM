(function ($) {
    $.districts = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#District-form",
            formContainer: ".js-District-form-container",
            gridSelector: "#District-grid",
            gridContainer: ".js-District-grid-container",
            editSelector: ".js-District-edit",
            saveSelector: ".js-District-save",
            selectAllSelector: "#District-check-all",
            deleteSelector: ".js-District-delete-confirm",
            deleteModal: "#District-delete-modal",
            finalDeleteSelector: ".js-District-delete",
            clearSelector: ".js-District-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-District-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-District-check-duplicateName",
            haseFile: false,
        ...
        var baseControllerNameUrl = "/Districts";
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-DistrictId-code").val();
                let name = self.val();
            ...
            $("body").on('click', settings.deleteSelector, function (e) {
                ...
                if (selectedIds.length === 0) {
                    toastr.error('Please District to delete.');
                    return;
                }
            ...
            $("body").on('click', settings.finalDeleteSelector, function (e) {
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        toastr.error('An error District .');
                        $(settings.deleteModal).modal('hide');
                    }
                });
            });
        ...
        function GenerateNextCode() {
            $(".js-DistrictId-code").val('');
            $.ajax({
                type: 'GET',
                url: nextCodeULR,
                success: function (result) {

                    $('.js-DistrictId-code').val(result);
                },
                error: function () {
