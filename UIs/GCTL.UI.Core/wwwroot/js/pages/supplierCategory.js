(function ($) {
    $.supplierCategory = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#SupplierCategory-form",
            formContainer: ".js-SupplierCategory-form-container",
            gridSelector: "#SupplierCategory-grid",
            gridContainer: ".js-SupplierCategory-grid-container",
            editSelector: ".js-SupplierCategory-edit",
            saveSelector: ".js-SupplierCategory-save",
            selectAllSelector: "#SupplierCategory-check-all",
            deleteSelector: ".js-SupplierCategory-delete-confirm",
            deleteModal: "#SupplierCategory-delete-modal",
            finalDeleteSelector: ".js-SupplierCategory-delete",
            clearSelector: ".js-SupplierCategory-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-SupplierCategory-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-SupplierCategory-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-SupplierCategoryId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#SupplierCategory').val();

            if (!col) {
                toastr.info('Enter Supplier Category');
                $('#SupplierCategory').trigger('focus');
                return false;
            }
            return true;
        }
