(function ($) {
    $.deliveryPeriods = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#deliveryPeriod-form",
            formContainer: ".js-deliveryPeriod-form-container",
            gridSelector: "#deliveryPeriod-grid",
            gridContainer: ".js-deliveryPeriod-grid-container",
            editSelector: ".js-deliveryPeriod-edit",
            saveSelector: ".js-deliveryPeriod-save",
            selectAllSelector: "#deliveryPeriod-check-all",
            deleteSelector: ".js-deliveryPeriod-delete-confirm",
            deleteModal: "#deliveryPeriod-delete-modal",
            finalDeleteSelector: ".js-deliveryPeriod-delete",
            clearSelector: ".js-deliveryPeriod-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-deliveryPeriod-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-deliveryPeriod-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadDeliveryPeriods(settings.baseUrl, settings.gridSelector);
            initialize();
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-deliveryPeriod-code").val();
                let name = self.val();
        ...
        function loadDeliveryPeriods(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "deliveryPeriodId", "className": "text-center", width: "40px", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "deliveryPeriodId", "className": "text-center", "render": function (data) {
                            return `<a class='btn js-deliveryPeriod-edit' data-id='${data}'>${data}</a>`;
                        }
                    },
