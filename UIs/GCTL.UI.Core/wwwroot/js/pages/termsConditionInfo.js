(function ($) {
    $.termsConditionInfo = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#TermsConditionInfo-form",
            formContainer: ".js-TermsConditionInfo-form-container",
            gridSelector: "#TermsConditionInfo-grid",
            gridContainer: ".js-TermsConditionInfo-grid-container",
            editSelector: ".js-TermsConditionInfo-edit",
            saveSelector: ".js-TermsConditionInfo-save",
            selectAllSelector: "#TermsConditionInfo-check-all",
            deleteSelector: ".js-TermsConditionInfo-delete-confirm",
            deleteModal: "#TermsConditionInfo-delete-modal",
            finalDeleteSelector: ".js-TermsConditionInfo-delete",
            clearSelector: ".js-TermsConditionInfo-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-TermsConditionInfo-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-TermsConditionInfo-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-TermsConditionId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#TermsConditionName').val();

            if (!col) {
                toastr.info('Enter Terms Condition Name');
                $('#TermsConditionName').trigger('focus');
                return false;
            }
            return true;
        }
