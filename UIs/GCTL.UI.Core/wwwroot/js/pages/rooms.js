(function ($) {
    $.rooms = function (options) {
        ...
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#room-form",
            formContainer: ".js-room-form-container",
            gridSelector: "#room-grid",
            gridContainer: ".js-room-grid-container",
            editSelector: ".js-room-edit",
            saveSelector: ".js-room-save",
            selectAllSelector: "#room-check-all",
            deleteSelector: ".js-room-delete-confirm",
            deleteModal: "#room-delete-modal",
            finalDeleteSelector: ".js-room-delete",
            clearSelector: ".js-room-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-room-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-room-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadRooms(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadRooms(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "roomCode", "className": "text-center", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "roomCode", "render": function (data) {
                            return `<a class='btn js-room-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },                
