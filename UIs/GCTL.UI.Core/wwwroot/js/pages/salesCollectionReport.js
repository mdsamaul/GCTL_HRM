(function ($) {
    $.salesCollectionReport = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
        ...
        $(() => {
            ...
            $("body").on("click", ".js-collection-export", function () {
                ...
                window.open(
                    settings.baseUrl + `/Export?billTypeId=${billType}&patientTypeId=${patientType}&fromDate=${fromDate}&toDate=${toDate}&billStatus=${billStatus}&doctorId=${doctorId}&referenceId=${referenceId}&reportType=SalesCollectionReport&reportRenderType=${reportRenderType}`,
                    "_blank"
                )
            });
        ...
        function previewReport() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    reportType: "SalesCollectionReport",
