    ...
    $.testEntries = function (options) {
        ...
        $(() => {
            ...
            $("body").on("click", "#testentrydetails .js-add", function () {
                ...
                var TestSubCategoryCodeName = "";
                if ($("#TestEntry_TestSubCategoryCode").val() == '') {

                }
                else {
                    TestSubCategoryCodeName = $("#TestEntry_TestSubCategoryCode option:selected").text();
                }


                var GettestChargeName = "";
               if ($("#TestEntry_TestChargeCode").val() == '') {
                  
                }
                else {
                   GettestChargeName = $("#TestEntry_TestChargeCode option:selected").text();
                }

                var GetDiscountPercent = "0";
                if ($("#TestEntry_DiscountPercent").val() != '') {
                    GetDiscountPercent = $("#TestEntry_DiscountPercent").val()
                }
                var GetDiscountAmount = "0";
                if ($("#TestEntry_DiscountAmount").val() != '') {
                    GetDiscountAmount = $("#TestEntry_DiscountAmount").val()
                }
                //if ($("#TestEntry_TestChargeCode").val() == '') {
                ...
                let testCategoryName = $("#TestEntry_TestCategoryCode option:selected").text(),
                    ...
                    testSubCategoryName = TestSubCategoryCodeName,
                    testSubCategoryCode = $("#TestEntry_TestSubCategoryCode").val(),

                    testChargeName = GettestChargeName,
                    ...
                    discountPercent = parseFloat(GetDiscountPercent),
            ...
            $("body").on("change", "#TestEntry_TestSubCategoryCode", function () {
                ...
                if ($("#TestEntry_TestChargeCode").val() == "") {
                    ...
                    if (self.val().length > 0) {
                        $.ajax({
                            url: settings.baseUrl + "/GetTestDiscountDetailsFromSubCatagory",
                            method: "POST",
                            data: { TestSubCategoryCode: self.val() },
                            success: function (response) {
                                console.log(response);
            ...
            $("body").on("change", "#TestEntry_TestChargeCode", function () {
                ...
                if (self.val().length > 0) {
                    //calculateDeliveryTime($("#TestEntry_TestCategoryCode").val(),
                    //    $("#TestEntry_TestChargeCode").val());
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#TestEntry_TestCategoryCode").val(response.testCategoryId).change();
                            $("#TestEntry_TestSubCategoryCode").val(response.testSubCategoryCode).change();
            ...
            //$("body").on("keyup", ".TestEntryTestAmount", function () {
            //   // calculateDiscountAmount();
            ...
            $("body").on("click", ".js-testEntry-patientPreivew", function (e) {
                loadPatients(settings.baseUrl, settings.gridSelector);
            });
            ...
            $("body").on("click", ".js-testentry-GridPreivew", function (e) {
            ...
            {
                var amountSelector = $("#TestEntry_Amount").val();
                if (amountSelector == "") {
                    amountSelector = "0";
                }
                var discountPercentSelector = $("#TestEntry_DiscountPercent").val();
                if (discountPercentSelector == "") {
                    discountPercentSelector = "0";
                }
                var discountAmountSelector = $("#TestEntry_DiscountAmount").val();
                if (discountAmountSelector == "") {
                    discountAmountSelector = "0";
                }
                var discountAmount = 0;

                if (parseFloat(discountPercentSelector) > 0) {
                    discountAmount = (parseFloat(amountSelector) * parseFloat(discountPercentSelector)) / 100;
                    $("#TestEntry_DiscountAmount").val(discountAmount);
                    $("#TestEntry_LineTotal").val(parseFloat(amountSelector) - parseFloat(discountAmount));


                }
                else {
                    var ada = parseFloat(amountSelector) - parseFloat(discountAmountSelector);

                    $("#TestEntry_LineTotal").val(ada);

                }
            }
            $("body").on("keyup", ".TempCalCulate", function () {
        ...
        function loadTestEntries(baseUrl, gridSelector) {
            ...
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    ...
                    { "data": "isApproved", "className": "text-center", width: "50px" },
