(function ($) {
    $.deliveryMethodInfo = function (options) {

        //#region Default options

        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#DeliveryMethodInfo-form",
            formContainer: ".js-DeliveryMethodInfo-form-container",
            gridSelector: "#DeliveryMethodInfo-grid",
            gridContainer: ".js-DeliveryMethodInfo-grid-container",
            editSelector: ".js-DeliveryMethodInfo-edit",
            saveSelector: ".js-DeliveryMethodInfo-save",
            selectAllSelector: "#DeliveryMethodInfo-check-all",
            deleteSelector: ".js-DeliveryMethodInfo-delete-confirm",
            deleteModal: "#DeliveryMethodInfo-delete-modal",
            finalDeleteSelector: ".js-DeliveryMethodInfo-delete",
            clearSelector: ".js-DeliveryMethodInfo-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-DeliveryMethodInfo-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-DeliveryMethodInfo-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-DeliveryMethodId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#DeliveryMethod').val();

            if (!col) {
                toastr.info('Enter Delivery Method');
                $('#DeliveryMethod').trigger('focus');
                return false;
            }
            return true;
        }
