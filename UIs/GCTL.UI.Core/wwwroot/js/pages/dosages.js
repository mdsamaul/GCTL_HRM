(function ($) {
    $.dosages = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#dosage-form",
            formContainer: ".js-dosage-form-container",
            gridSelector: "#dosage-grid",
            gridContainer: ".js-dosage-grid-container",
            editSelector: ".js-dosage-edit",
            saveSelector: ".js-dosage-save",
            selectAllSelector: "#dosage-check-all",
            deleteSelector: ".js-dosage-delete-confirm",
            deleteModal: "#dosage-delete-modal",
            finalDeleteSelector: ".js-dosage-delete",
            clearSelector: ".js-dosage-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-dosage-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-dosage-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadDosages(settings.baseUrl, settings.gridSelector);
            initialize();
        ...
        function loadDosages(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "medicineDosageCode", "className": "text-center", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "medicineDosageCode", "render": function (data) {
                            return `<a class='btn js-dosage-edit' data-id='${data}'><i>${data}</i></a>`;
                        }
                    },
                    { "data": "medicineDosageName", "autowidth": true, "className": "text-center" }
                ],
                lengthChange: true,
                pageLength: 10,
                lengthMenu: [
