(function ($) {
    $.country = function (options) {
        ...
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#Country-form",
            formContainer: ".js-Country-form-container",
            gridSelector: "#Country-grid",
            gridContainer: ".js-Country-grid-container",
            editSelector: ".js-Country-edit",
            saveSelector: ".js-Country-save",
            selectAllSelector: "#Country-check-all",
            deleteSelector: ".js-Country-delete-confirm",
            deleteModal: "#Country-delete-modal",
            finalDeleteSelector: ".js-Country-delete",
            clearSelector: ".js-Country-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-Country-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-Country-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-CountryId-code").val();
                let name = self.val();
                // check
                $.ajax({
        ...
        function validation() {
            ...
            var col = $('#CountryName').val();

            if (!col) {
                toastr.info('Enter Country Name');
