...
(function ($) {
    $.hrmDefInstitutes = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefInstitutes-form",
            formContainer: ".js-HrmDefInstitutes-form-container",
            gridSelector: "#HrmDefInstitutes-grid",
            gridContainer: ".js-HrmDefInstitutes-grid-container",
            editSelector: ".js-HrmDefInstitutes-edit",
            saveSelector: ".js-HrmDefInstitutes-save",
            selectAllSelector: "#HrmDefInstitutes-check-all",
            deleteSelector: ".js-HrmDefInstitutes-delete-confirm",
            deleteModal: "#HrmDefInstitutes-delete-modal",
            finalDeleteSelector: ".js-HrmDefInstitutes-delete",
            clearSelector: ".js-HrmDefInstitutes-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefInstitutes-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefInstitutes-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-InstituteCode-code").val();
                let name = self.val();
        ...
        function validation() {
            ...
            var degName = $('#InstituteName').val();
            if (!degName) {
                toastr.info('Enter Institute Name');
                $('#InstituteName').trigger('focus');
                return false;
            }
