...
(function ($) {
    $.hrmDefDegrees = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#HrmDefDegrees-form",
            formContainer: ".js-HrmDefDegrees-form-container",
            gridSelector: "#HrmDefDegrees-grid",
            gridContainer: ".js-HrmDefDegrees-grid-container",
            editSelector: ".js-HrmDefDegrees-edit",
            saveSelector: ".js-HrmDefDegrees-save",
            selectAllSelector: "#HrmDefDegrees-check-all",
            deleteSelector: ".js-HrmDefDegrees-delete-confirm",
            deleteModal: "#HrmDefDegrees-delete-modal",
            finalDeleteSelector: ".js-HrmDefDegrees-delete",
            clearSelector: ".js-HrmDefDegrees-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-HrmDefDegrees-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-HrmDefDegrees-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-DegreeCode-code").val();
                let name = self.val();
        ...
        function validation()
        {
            ...
            var degName = $('#DegreeName').val();
            if (!degName)
            {
                toastr.info('Enter Degree Name');
                $('#DegreeName').trigger('focus');
                return false;
            }
