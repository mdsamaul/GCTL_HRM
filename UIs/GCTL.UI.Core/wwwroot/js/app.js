(function ($) {
    $.app = function (options) {
        ...
        var settings = $.extend({
            ...
            formContainer: ".app-setup-form",
            gridSelector: "#commonGrid",
            gridContainer: ".app-grid-container",
            editSelector: ".js-edit",
            saveSelector: ".js-save",
            selectAllSelector: "#checkAll",
            deleteSelector: ".js-delete-confirm",
            deleteModal: "#deleteModal",
            finalDeleteSelector: ".js-delete",
            clearSelector: ".js-clear",
            topSelector: ".js-go",
            decimalSelector: ".decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-check-availability",
            haseFile: false,
